...
if __name__ == "__main__": 
    ...
    u_train_pd = pd.DataFrame(u_train)
    ...
    ax = plt.subplot(gs2[:, :])
    ax.axis('off')
    t_pd.to_csv('t_pd_csv.csv')
    x_pd.to_csv('x_pd_csv.csv')
    Exact_pd.to_csv('Exact_pd_csv.csv')
    X_pd.to_csv('X_pd_csv.csv')
    T_pd.to_csv('T_pd_csv.csv')
    U_pred_pd.to_csv('U_pred_pd_csv.csv')
    u_train_pd.to_csv('u_train_pd_csv.csv')
